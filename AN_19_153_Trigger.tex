...
\\ \\
Table.~\ref{tab:event_selection_cutflow} shows the event selection in data and Monte Carlo. The data are found to be consistent with the Monte Carlo prediction. Figures~\ref{fig:data_vs_mc_1}-\ref{fig:data_vs_mc_7} shows the agreement between data and Monte Carlo for several event variables.
...
\caption{Data vs Monte Carlo comparisons in the control region. Properties of the leading muon.}
\end{figure}
...
\caption{Data vs Monte Carlo comparisons in the control region. Properties of the leading muon (continued).}
...
\caption{Data vs Monte Carlo comparisons in the control region. Properties of the second muon.}
...
\caption{Data vs Monte Carlo comparisons in the control region. Properties of the second muon (continued).}
...
\caption{Data vs Monte Carlo comparisons in the control region. Properties of the third muon.}
...
\caption{Data vs Monte Carlo comparisons in the control region. Properties of the third muon (continued).}
...
\newpage
\section{Results} 
The trigger efficiency on Monte Carlo is evaluated as $\varepsilon_\mathrm{WZTo3LNu} = 385.37 / 389.29 = 0.99$, $\varepsilon_\mathrm{ZZTo4L} = 23.21/23.46= 0.99$. Efficiency in data is observed to be $\varepsilon_\mathrm{Data} = 396 / 402 = 0.985$. This results in a trigger scale factor of $SF = 0.985 /  0.99 =0.995$. A statistical uncertainty of 5\% on the selected data events is quoted in the control region. The overall trigger scale factor is estimated to be $99.5\% \pm 5\%~(\mathrm{stat.})$.
\end{document}
